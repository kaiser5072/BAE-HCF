...
for i in 0 1 2 3 4
do
    python main.py --dims 500 200 --data_dir 'Input/tmp' -b 512 -e 1400 --display_every 4000 --l2_lambda 0.00004 -r 0.0 -f $i -r 0.5
done

for i in 0 1 2 3 4
do
    python main.py --dims 500 200 --data_dir 'Input/tmp' -b 512 -e 1400 --display_every 4000 --l2_lambda 0.00004 -r 0.0 -f $i -m predict
done
